...
global.channelLink = "https://whatsapp.com/channel/0029Vb7NvfxJ93wXUdFG3x3X";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb7NvfxJ93wXUdFG3x3X'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/EnbFJVCkL63Gco46pdwLsK`
                }, { quoted: message });
                return;
            }
        }
